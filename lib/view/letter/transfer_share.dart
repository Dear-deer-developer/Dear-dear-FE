...
class TransferShare extends StatelessWidget {
  const TransferShare({super.key});
  ...
  AppBar _appbar() => AppBar(
        ...
        title: Padding(
          ...
          child: Text('저장 완료', style: FontStyles.H2_bold_17),
        ),
        centerTitle: false,
      );
  ...
  Widget _middle() => Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text('우편이 성공적으로 저장되었습니다!', style: FontStyles.B3_bold_15),
            ),
          ),
          Center(
            child: Text('편지의 주인이 링크를 눌러야만 전송 완료됩니다. \n링크를 공유해 주세요!',
